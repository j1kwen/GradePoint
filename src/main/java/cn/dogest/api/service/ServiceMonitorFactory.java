...
public final class ServiceMonitorFactory {
    ...
    public static List<Object> getServiceMonitors() {
        List<Class<?>> classes = getAllClassByPackageName(ServiceMonitorFactory.class.getPackage());
        List<Object> monitors = new ArrayList<>();
        for(Class clz : classes) {
            try {
                Object obj = clz.newInstance();
                if(obj instanceof IServiceMonitor) {
                    monitors.add(obj);
                }
            } catch (Exception e) {}
        }
