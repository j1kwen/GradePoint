...
public class ResultModel {
    ...
    private BigDecimal totalGrade; // 总绩点
    private BigDecimal totalPoint; // 总学分
    private BigDecimal elective; // 已修公选课学分
    private List<Course> list;  // 课程信息及成绩列表

    public ResultModel(BigDecimal grade, BigDecimal point, BigDecimal totalGrade, BigDecimal totalPoint, BigDecimal elective, List<Course> list) {
        this.grade = grade;
        this.point = point;
